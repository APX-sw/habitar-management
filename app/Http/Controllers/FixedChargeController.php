...
class FixedChargeController extends Controller
{
    public function store(Request $request)
    {
        $request->validate([
            ...
            'name' => 'nullable|string|max:255|required_without:recurrent_concept_id',
            'recurrent_concept_id' => 'nullable|exists:recurrent_concepts,id|required_without:name',
        ...
        FixedCharge::create([
            ...
            'recurrent_concept_id' => $request->recurrent_concept_id,
            'name' => $request->name,
