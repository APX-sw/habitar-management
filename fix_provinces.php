...
$data = [
    ...
    'Santiago del Estero' => ['Santiago del Estero', 'La Banda', 'Termas de Río Hondo', 'Añatuya', 'Frías', 'Quimilí', 'Capital'],
...
// Update the existing property to match new IDs
$santiago = Province::where('name', 'Santiago del Estero')->first();
$capital = City::where('province_id', $santiago->id)->where('name', 'Santiago del Estero')->first();

Property::where('id', 1)->update([
