...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            @canany(['rrhh_employees.read', 'rrhh_attendances.read', 'rrhh_office.read', 'rrhh_objectives.read'])
            <li class="sidebar-item">
